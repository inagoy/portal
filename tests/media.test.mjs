...
assert.equal(getInlineMedia("https://bandcamp.com/EmbeddedPlayer/album=159166449/")?.platform, "bandcamp");
assert.equal(getInlineMedia("https://bandcamp.com/EmbeddedPlayer/album=159166449/")?.maxWidth, 700);
